...
${SAIR}                      //div[@class='navbar-row'][contains(.,'Sair')]
##
...
&{DADOS_FINANCEIROS}         dadof1=3000            dadof2=7600            dadof3=3450            dadof4=6314            dadof5=4579
...
Abrir a LandingPage do Focus
    Go To    url=https://dev.v2.focus.apps.sebraemg.com.br/#/
...
Clicar em "Comece agora"
    ...
    Wait Until Element Is Visible    locator=//button[@class='aviso_button__1KSlS'][contains(.,'Entrar')]
    Click Button                     locator=//button[@class='aviso_button__1KSlS'][contains(.,'Entrar')] 
    Sleep                            2s     
...
Alterar dados de empresa
    Go To    url=https://dev.v2.focus.apps.sebraemg.com.br/#/app/minha-empresa
...
Apagar campos da tela de lançar dados
    Go To                                                       url=https://dev.v2.focus.apps.sebraemg.com.br/#/app/dados
    Preencher dados de login e logar
    Go To                                                       url=https://dev.v2.focus.apps.sebraemg.com.br/#/app/dados
    Sleep                                                       time_=5s
    Abrir a empresa
...
Fazer Logoff
    Sleep                             time_=2s    
    Click Element                     locator=//i[contains(@class,'fas fa-user navbar-icone')]
    Sleep                             time_=2s
    Click Element                     locator=${SAIR}
    Wait Until Element Is Visible     locator=//video[contains(@class,'homeVid')]

Apagar campos da tela de plano de ação
    Go To                                        url=https://dev.v2.focus.apps.sebraemg.com.br/#/app/planos
    Sleep                             time_=2s
    Wait Until Element Is Visible     locator=username
