...
Abrir a LandingPage do Focus
    Go To    url=http://hm.v2.focus.apps.sebraemg.com.br/#/
...
Alterar dados de empresa
    Go To    url=http://hm.v2.focus.apps.sebraemg.com.br/#/app/minha-empresa
...
Apagar campos da tela de lançar dados
    Go To                                                       url=http://hm.v2.focus.apps.sebraemg.com.br/#/app/dados
    Preencher dados de login e logar
    Go To                                                       url=http://hm.v2.focus.apps.sebraemg.com.br/#/app/dados
    Sleep                                                       time_=5s
    Abrir a empresa
...
Apagar campos da tela de plano de ação
    Go To                                        url=http://hm.v2.focus.apps.sebraemg.com.br/#/app/planos
    Sleep                             time_=2s
    Wait Until Element Is Visible     locator=username
